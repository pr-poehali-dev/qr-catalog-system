...
const PASSWORD = "2024";
const COOKIE_NAME = "catalog_auth";
...
export default function PasswordGate({ children }: PasswordGateProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 font-golos">
      <div
        className={`w-full max-w-sm animate-scale-in ${shake ? "animate-shake" : ""}`}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="relative">
            <input
              ...
              placeholder="Пароль"
              autoFocus
              className={`w-full px-4 py-3 rounded-xl border text-sm font-ibm outline-none transition-all duration-200 ${
                error
